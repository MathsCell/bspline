...
Let
$$ \beta_i = k \frac{\alpha_i - \alpha_{i-1}}{t_{i+k} - t_i} $$
Then
...
If $\beta_i$ is  considered as known and we have to find $\alpha_i$, we get
$$
 \alpha_i = \beta_i \frac{t_{i+k}-t_i}{k} + \alpha_{i-1}
$$
here $\alpha_0$ being a freely defined constant. In term of cumulative sum, it gives
$$
